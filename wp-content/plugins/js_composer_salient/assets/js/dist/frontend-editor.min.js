...
(c => {
    window.vc.AddElementUIPanelFrontendEditor = vc.AddElementUIPanelBackendEditor.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
        ...
        createElement: function(e) {
            var t, r, i, d, s, n, o;
            for (e && e.preventDefault && e.preventDefault(), s = (e = c(e.currentTarget)).data("tag"), d = {}, i = {
                    width: "1/1"
                }, (e = e.closest("[data-preset]")) && (n = e.data("preset"), o = e.data("element")), this.prepend && (window.vc.activity = "prepend"), 0 == this.model ? "vc_section" === s ? (e = {
                    shortcode: s
                }, n && "vc_section" === o && (e.preset = n), this.builder.create(e)) : (e = {
                    shortcode: "vc_row",
                    params: d
                }, n && "vc_row" === o && (e.preset = n), this.builder.create(e), e = {
                    shortcode: "vc_column",
                    parent_id: this.builder.lastID(),
                    params: i
                }, n && "vc_column" === o && (e.preset = n), this.builder.create(e), "vc_row" !== s && (t = {
                    shortcode: s,
                    parent_id: this.builder.lastID()
                }, n && o === s && (t.preset = n), this.builder.create(t))) : "vc_row" === s ? "vc_section" === this.model.get("shortcode") ? this.builder.create({
                    shortcode: "vc_row",
                    params: d,
                    parent_id: this.model.id,
                    ...
                    parent_id: this.model.id,
                    order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.nextOrder()
                }, n && o === s && (t.preset = n), this.builder.create(t)), this.model = this.builder.last(), r = this.builder.models.length - 1; 0 <= r; r--) this.builder.models[r].get("shortcode");
            _.isString(vc.getMapped(s).default_content) && vc.getMapped(s).default_content.length && (d = this.builder.parse({}, window.vc.getMapped(s).default_content, this.builder.last().toJSON()), _.each(d, function(e) {
                e.default_content = !0, this.builder.create(e)
            }, this)), this.model || (this.model = this.builder.last()), window.vc.latestAddedElement = this.model, i = !(_.isBoolean(vc.getMapped(s).show_settings_on_create) && !1 === vc.getMapped(s).show_settings_on_create), this.hide(), i && this.showEditForm(), this.builder.render(null, this.model)
        }
    })
})(window.jQuery);
(r => {
