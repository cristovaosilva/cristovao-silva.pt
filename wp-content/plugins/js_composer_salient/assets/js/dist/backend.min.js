...
(o => {
    window.vc.element_start_index = 0, window.vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).vcExtendUI(vc.HelperPanelTabs).extend({
        ...
        createElement: function(e) {
            var t, i, n, a, s, c, d, r, l;
            e && e.preventDefault && e.preventDefault(), d = (e = o(e.currentTarget)).data("tag"), c = {}, s = {
                width: "1/1"
            }, (e = e.closest("[data-preset]")) && (r = e.data("preset"), l = e.data("element")), !1 === this.model ? (window.vc.storage.lock(), "vc_section" === d ? (e = {
                shortcode: d
            }, r && "vc_section" === l && (e.preset = r), i = vc.shortcodes.create(e)) : (e = {
                shortcode: "vc_row",
                params: c
            }, r && l === d && (e.preset = r), e = {
                shortcode: "vc_column",
                ...
                root_id: a.id
            }, r && "vc_column" === l && (e.preset = r), n = vc.shortcodes.create(e), i = a, "vc_row" !== d && (t = {
                shortcode: d,
                parent_id: n.id,
                root_id: a.id
            }, r && l === d && (t.preset = r), i = vc.shortcodes.create(t)))) : i = "vc_row" === d ? (n = "vc_section" === this.model.get("shortcode") ? (window.vc.storage.lock(), a = vc.shortcodes.create({
                shortcode: "vc_row",
                params: c,
                parent_id: this.model.id,
                order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.getNextOrder()
                ...
                order: this.prepend ? this.getFirstPositionIndex() : vc.shortcodes.getNextOrder(),
                root_id: this.model.get("root_id")
            }, r && l === d && (t.preset = r), vc.shortcodes.create(t)), this.model = i, window.vc.latestAddedElement = i, s = !(_.isBoolean(vc.getMapped(d).show_settings_on_create) && !1 === vc.getMapped(d).show_settings_on_create), this.model.get("shortcode"), this.hide(), s && this.showEditForm()
    ...
    var r = Backbone.View.extend({
        ...
        p = Backbone.View.extend({
            ...
            addNew: function(e) {
                ...
                e.preventDefault(), this.addAllowed() && (void 0 === this.options.param.callbacks || void 0 === this.options.param.callbacks.before_add || "function" != typeof(t = window[this.options.param.callbacks.before_add]) || t()) && ((t = d(JSON.parse(this.$ul.next(".vc_param_group-template").html()))).removeClass("vc_param_group-add_content-wrapper"), t.insertBefore(e.currentTarget), t.show(), this.initializer.setContent(t.find("> .wpb_element_wrapper")), this.initializer.render(), this.items++, t.data("vc-param-group-param", new u({
                    el: t,
                    parent: this
                })), this.afterAdd(t, "new"), window.vc_auto_save && vc.edit_element_block_view.save(), vc.events.trigger("vc-param-group-add-new", e, t, this))
            },
            addAllowed: function() {
        ...
        u = Backbone.View.extend({
            ...
            hookAdminLabel: function(e) {
                for (var t = "", n = "", a = [], i = (s = d(e.currentTarget)).closest(".vc_param_group-wrapper"), e = s.closest(".vc_param").find(".vc_param-group-admin-labels"), o = 0; o < this.adminLabelParams.length; o++) {
                    ...
                    void 0 !== this.mappedParams[r] && (t = this.mappedParams[r].heading), n = s.is("select") ? s.find("option:selected").text() : !s.is("input:checkbox") || s[0].checked ? s.val() : "", "textarea_raw_html" === (r = {
                        type: l.data("param_type"),
                        param_name: l.data("param_name")
                    }).type || "textarea_ace" === r.type || "textarea_safe" === r.type || "exploded_textarea" === r.type ? n = n || "" : _.isObject(vc.atts[r.type]) && _.isFunction(vc.atts[r.type].render) && (n = vc.atts[r.type].render.call(this, r, n)), "" !== n && a.push("<label>" + _.escape(t) + "</label>: " + _.escape(n))
                }
            ...
            deleteParam: function(e) {
                e && e.preventDefault && e.preventDefault(), !0 === confirm(window.i18nLocale.press_ok_to_delete_section) && (this.options.parent.items--, this.options.parent.afterDelete(), this.$el.remove(), this.unbind(), this.remove(), window.vc_auto_save) && vc.edit_element_block_view.save()
            },
            content: function() {
                return this.$content
            },
            clone: function(e) {
                ...
                e.preventDefault(), this.options.parent.addAllowed() && (e = this.options.parent.$ul.data("settings"), t = this.$content, this.$content = this.$el, n = vc.atts.param_group.parseOne.call(this, e), d.ajax({
                    ...
                    })), this.options.parent.items++, this.options.parent.afterAdd(e, "clone"), window.vc_auto_save && vc.edit_element_block_view.save()
                }))
            },
            toggle: function(e) {
                e.preventDefault();
        ...
        h = (vc.edit_form_callbacks = [], vc.atts = {
            parse: function(e) {
                var t = this.content().find(".wpb_vc_param_value[name=" + e.param_name + "]"),
                    ...
                    a = _.isUndefined(vc.atts[e.type]) || _.isUndefined(vc.atts[e.type].parse) ? t.length ? t.val() : null : n.data("vcInitParam") ? vc.atts[e.type].parse.call(this, e) : (n = this.model.get("params"), a = t.attr("type"), _.isUndefined(n[e.param_name]) ? t.length && ("checkbox" !== a || t.is(":checked")) ? t.val() : null : n[e.param_name]);
                return void 0 !== t.data("js-function") && void 0 !== window[t.data("js-function")] && (0, window[t.data("js-function")])(this.$el, this, e), a
            },
            parseFrame: function(e) {
                return vc.atts.parse.call(this, e)
            },
            parseText: function(e, t) {
                e = this.content().find(".wpb_vc_param_value[name=" + e.param_name + "]"), t = t ? window.vc.utils.sanitizeString(e.val()) : e.val(), e = e.attr("data-value-type");
                try {
            ...
            parse: function(t) {
                var n, e = this.window(),
                    t = this.content().find(".textarea_html." + t.param_name);
                try {
                    e.tinyMCE && _.isArray(e.tinyMCE.editors) && _.each(e.tinyMCE.editors, function(e) {
                ...
                try {
                    n = window.vc.utils.validateHtml(t.val())
                } catch (e) {
                    console.error("Error validating HTML content: ", e), n = t.val()
                }
                return n
            },
            render: function(e, t) {
            ...
            parse: function(e) {
                return vc.atts.parseText.call(this, e, !0)
            }
        }, vc.atts.textarea = {
            parse: function(e) {
                return vc.atts.parseText.call(this, e, !1)
            }
            ...
            render: function(e, t) {
                return t && t.match(/^#E\-8_/) ? d("<div/>").text(g(t.replace(/^#E\-8_/, ""))).html() : t
            }
        }, vc.atts.checkbox = {
            parse: function(e) {
                var t = [],
            ...
            parse: function(e) {
                e = vc.atts.parseText.call(this, e, !1);
                return base64_encode(rawurlencode(e))
            },
            render: function(e, t) {
                var n;
                return null != t && (n = g(t.trim()), t) ? d("<div/>").text(n).html() : ""
            }
            ...
            init: function(e, t) {
                var n, a = t.find(".textarea_ace_container"),
                    ...
                    t = a.attr("id");
                "undefined" != typeof ace ? ((n = ace.edit(t)).setTheme("ace/theme/chrome"), a = e.mode || "html", n.session.setMode("ace/mode/" + a), n.session.setOption("wrap", "free"), a = "", i.val() && (a = g(i.val())), n.setValue(a, -1), n.clearSelection(), n.getSession().on("change", function() {
                    var e = n.getValue();
                    try {
        ...
        vc.atts.attach_image = {
            ...
            render: function(e, t) {
                ...
                return "external_link" === this.model.getParam("source") && (t = (t = this.model.getParam("custom_srcs")).replace(/^#E\-8_/, ""), t = rawurldecode(base64_decode(t))), _.isEmpty(t) ? (this.$el.removeData("field-" + e.param_name + "-attach-images"), vc.atts.attach_images.updateImages(n, "")) : (f("get_gallery_images", e, t, this.model), vc.atts.attach_images.isParse && d.ajax({
                    type: "POST",
                    url: window.ajaxurl,
                    data: {
            ...
            extractValues: function(i, e) {
                ...
                return e.each(function() {
                    ...
                    o.$content = d(this), _.each(i.params, function(e) {
                        var t, e = d.extend({}, e),
                            n = e.param_name;
                        e.param_name = i.param_name + "_" + n, ((t = vc.atts.parse.call(o, e)) && t.length || e.save_always) && (a[n] = t)
                    }), t.push(a)
                }), t
            },
            parseOne: function(e) {
...
(a => {
    vc.shortcode_view = Backbone.View.extend({
        ...
        deleteShortcode: function(e) {
            _.isObject(e) && (e.preventDefault(), e.currentTarget.focus()), this.model.destroy()
        },
        addElement: function(e) {
            _.isObject(e) && (e.preventDefault(), e.currentTarget.focus()), vc.add_element_block_view.render(this.model, !_.isObject(e) || !a(e.currentTarget).closest(".bottom-controls").hasClass("bottom-controls"));
              /* nectar addition */
        ...
        editElement: function(e) {
            _.isObject(e) && (e.preventDefault(), e.currentTarget.focus()), vc.active_panel && vc.active_panel.model && this.model && (!vc.active_panel.model || !this.model || vc.active_panel.model.get("id") === this.model.get("id")) || (vc.closeActivePanel(), vc.edit_element_block_view.render(this.model))
        },
        clone: function(e) {
            _.isObject(e) && (e.preventDefault(), e.currentTarget.focus(), "touchstart" === e.type) && e.stopPropagation();
        ...
        paste: function(e) {
            return _.isObject(e) && (e.preventDefault(), e.currentTarget.focus()), vc.pasteShortcode(this.model)
        },
        cloneModel: function(e, t, n) {
            var c = "number" == typeof n ? n : vc.utils.getMidpointOrder(e),
                o = _.extend({}, e.get("params")),
                i = e.get("shortcode"),
    ...
    vc.saved_custom_css = !1, vc.createPreLoader = function() {
        ...
        initialize: function() {
            ...
            _.bindAll(this, "switchComposer", "dropButton", "processScroll", "updateRowsSorting", "updateElementsSorting"), this.accessPolicy = vc.accessPolicy, this.buildRelevance(), vc.events.on("shortcodes:add", vcAddShortcodeDefaultParams, this), vc.events.on("shortcodes:add", vc.atts.addShortcodeIdParam, this), vc.events.on("shortcodes:sync", vc.atts.addShortcodeIdParam, this), vc.events.on("shortcodes:add", this.addShortcode, this), vc.events.on("shortcodes:destroy", this.checkEmpty, this), vc.shortcodes.on("change:params", this.changeParamsEvents, this), vc.shortcodes.on("reset", this.addAll, this), r(document).on("wp-collapse-menu", function(e, t) {
                "open" === t.state && n.leaveFullscreen()
            }), this.render()
        },
        ...
        render: function() {
            ...
            this.$vcType = r("#wpb_vc_editor_type"),
           ...
           // nectar addition end
            this.$loading_block = r("#vc_logo"), vc.add_element_block_view = new vc.AddElementUIPanelBackendEditor({
                el: "#vc_ui-panel-add-element"
            ...
            }), r("body").on("click", r.proxy(this.handleBodyClick, this)), this.$vcStatus.val(!0), window.vc && window.vc.bindEditorKeys && window.vc.bindEditorKeys(), this
        },
        addAll: function() {
        ...
        appendShortcode: function(e) {
            var t = this.getView(e),
                n = _.extend(vc.getDefaults(e.get("shortcode")), e.get("params"));
            e.set("params", n, {
                silent: !0
            }), n = !1 !== e.get("parent_id") && this.views[e.get("parent_id")], this.views[e.id] = t, e.get("parent_id") && this.views[e.get("parent_id")].unsetEmpty(), n ? n.addShortcode(t, "append") : this.$content.append(t.render().el), t.ready(), t.changeShortcodeParams(e), t.checkIsEmpty(), this.setNotEmpty()
        },
        addShortcode: function(e) {
            var t, n = _.extend(vc.getDefaults(e.get("shortcode")), e.get("params")),
                s = (e.set("params", n, {
                    silent: !0
                }), t = this.getView(e), n = !1 !== e.get("parent_id") && this.views[e.get("parent_id")], t.use_default_content = !0 !== e.get("cloned"), this.views[e.id] = t, this);
            n ? (n.addShortcode(t), n.checkIsEmpty(), _.defer(function() {
                ...
                t.changeShortcodeParams && t.changeShortcodeParams(e), t.ready(), t.checkIsEmpty(), "vc_section" === t.model.get("shortcode") && s.setNotEmpty()
            }))
        },
        addRow: function(e) {
        ...
        addTextBlock: function(e) {
            ...
            return e && e.preventDefault && e.preventDefault(), e = vc.shortcodes.create({
                ...
                parent_id: e.id,
                root_id: e.id
            }), n = vc.getDefaults("vc_column_text"), vc.shortcodes.create({
        ...
        sortingStopped: function(e, t) {
            var n = t.item.data("element_type"),
                s = t.placeholder.closest("[data-element_type]").data("element_type") || "";
            vc.check_relevance(s, n) && s != n || (t.placeholder.addClass("vc_hidden-placeholder"), r(e.target).sortable("cancel")), r("#wpbakery_content").removeClass("vc_sorting-started")
        },
        updateElementsSorting: function(e, a) {
            _.defer(function(e) {
                var t, n = a.item.parent().closest("[data-model-id]").data("model"),
                    s = a.item.data("model"),
                    o = e.views[n.id].$content.find("> [data-model-id]"),
                    c = 0;
                _.isNull(a.sender) || (t = s.get("parent_id"), vc.storage.lock(), s.save({
                    parent_id: n.id
                }), t && e.views[t].checkIsEmpty(), e.views[n.id].checkIsEmpty()), o.each(function() {
        ...
        updateRowsSorting: function(a, i) {
            _.defer(function(e) {
                var t = i.item.parent(),
                    n = t.closest("[data-model-id]"),
                    n = !!n.length && n.data("model").get("id"),
                    s = i.item.data("model"),
                    o = i.item.data("element_type"),
                    c = i.item.parent().closest("[data-element_type]").data("element_type") || "";
                vc.check_relevance(c, o) && c != o ? (c = s.get("parent_id"), t.find(e.rowSortableSelector).each(function() {
                    var e = r(this).index();
                    ...
                    parent_id: n
                }), c && e.views[c].checkIsEmpty(), n && e.views[n].checkIsEmpty()) : r(a.target).sortable("cancel")
            }, this)
        },
        renderPlaceholder: function(e, t) {
            var t = r(t).data("element_type"),
                n = _.isObject(vc.map[t]) && (_.isBoolean(vc.map[t].is_container) && !0 === vc.map[t].is_container || !_.isEmpty(vc.map[t].as_parent));
            return r('<div class="vc_helper vc_helper-' + t + '"><i class="vc_general vc_element-icon' + (vc.map[t].icon ? " " + vc.map[t].icon : "") + '"' + (n ? ' data-is-container="true"' : "") + "></i> " + vc.map[t].name + "</div>").prependTo("body")
        },
        ...
        setSortable: function() {
            if (vc_user_access().partAccess("dragndrop")) return r(".wpb_main_sortable").sortable({
                ...
                over: function(e, t) {
                    var n = t.item.data("element_type"),
                        s = t.placeholder.closest("[data-element_type]").data("element_type") || "";
                    if (!vc.check_relevance(s, n) || s == n) return t.placeholder.addClass("vc_hidden-placeholder"), !1;
                    t.placeholder.css({
                ...
                stop: function(e, t) {
                    ...
                    var n = t.item.data("element_type"),
                        s = t.item.parent().closest("[data-element_type]").data("element_type") || "",
                        o = !!_.isUndefined(vc.map[s].allowed_container_element) || vc.map[s].allowed_container_element;
                    vc.check_relevance(s, n) && s != n || r(this).sortable("cancel"), _.isObject(vc.map[n]) && (_.isBoolean(vc.map[n].is_container) && !0 === vc.map[n].is_container || !_.isEmpty(vc.map[n].as_parent)) && !0 !== o && o !== t.item.data("element_type").replace(/_inner$/, "") && r(this).sortable("cancel"), r(".vc_sorting-empty-container").removeClass("vc_sorting-empty-container")
                },
        ...
        switchEditorsUrlParams: function(e, t) {
            var n = new URL(window.location.href),
                e = (n.searchParams.delete(e), n.href.replace(/#$/, ""));
            n.searchParams.has(t) || (-1 === e.indexOf("?") ? window.history.replaceState(null, "", e + "?" + t) : window.history.replaceState(null, "", e + "&" + t))
        },
        ...
        processScroll: function(e) {
            var t, n;
            !0 === this.disableFixedNav ? this.$nav.removeClass("vc_subnav-fixed") : ((!this.navTop || this.navTop < 0) && this.setNavTop(), t = this.$nav.hasClass("vc_subnav-fixed"), this.scrollTop = parseInt(r(window).scrollTop() - 10), 0 < this.navTop && this.scrollTop >= this.navTop && !this.isFixed ? (this.isFixed = 1, !this.dummyNav && 1005 < window.innerWidth && (n = r('<div class="vc-dummy-nav" style="height:' + this.$nav.outerHeight() + 'px"></div>'), this.$nav.after(n), this.dummyNav = n), this.$nav.addClass("vc_subnav-fixed")) : (this.scrollTop <= this.navTop && this.isFixed && 1005 < window.innerWidth || 1005 < window.innerWidth && 10 === this.scrollTop) && 1066 <= window.innerWidth && (this.isFixed = 0, this.dummyNav && 1005 < window.innerWidth && (this.dummyNav.remove(), this.dummyNav = !1), this.$nav.removeClass("vc_subnav-fixed"), this.setNavTop()), e && "resize" === e.type && this.scrollTop < this.navTop && (window.innerWidth < 1066 && !t ? this.$nav.addClass("vc_subnav-fixed") : 1066 < window.innerWidth && t && this.$nav.removeClass("vc_subnav-fixed")), 0 !== this.$nav.length && (window.innerWidth <= 600 ? 46 < window.scrollY ? "0px" !== this.$nav.css("top") && this.$nav.css("top", "0") : (n = 46 - window.scrollY + "px", this.$nav.css("top") !== n && this.$nav.css("top", n)) : "" !== this.$nav.css("top") && this.$nav.css("top", "")))
        },
...
(i => {
    ...
    window.VcRowView = vc.shortcode_view.extend({
        ...
        deleteShortcode: function(e) {
            ...
            e && e.preventDefault && e.preventDefault(), this.model.destroy(), n && !vc.shortcodes.where({
                parent_id: n
    ...
    /* nectar addition end */
        ...
        deleteShortcode: function(e) {
            return e && e.preventDefault && e.preventDefault(), 1 === vc.shortcodes.where({
                parent_id: this.model.get("parent_id")
...
(i => {
    ...
    var e = /(Mac|iPhone|iPod|iPad)/i.test(window.navigator.userAgent) ? "command" : "ctrl",
        ...
        a = {
            ...
            save: function(e, t) {
                e.preventDefault();
                var n, e = i(".vc_ui-panel-window.vc_active");
            ...
            preview: function(e, t) {
                e.preventDefault();
                e = i(".vc_ui-panel-window.vc_active");
                if (e.length && "vc_ui-panel-post-settings" === e.attr("id")) {
                    e = e.find("#wpb-settings-preview");
                    if (e.length) return e.trigger("click"), !1
                }
                var e = i(".vc_control-preview");
                return e.length ? e.trigger("click") : t && window.vc && window.vc.post_settings_view && (e = i("#wpb-settings-preview")).length && e.trigger("click"), !1
            },
            viewPage: function(e, t) {
                return e.preventDefault(), t ? (e = i(".vc_back-button")).length && e.attr("href") && window.open(e.attr("href"), "_blank") : (t = i("#sample-permalink a")).length && t.attr("href") && window.open(t.attr("href"), "_blank"), !1
            },
            openPanel: function(e, t, n) {
                return e.preventDefault(), n && n.buttonSelector && (e = i(n.buttonSelector).first()).length && e.trigger("click"), !1
            },
            switchTabs: function(e) {
                e.preventDefault();
                var t, e = i(".vc_ui-panel-window.vc_active");
                return e.length && 1 < (t = (t = e.find('[data-vc-ui-element="panel-tab-control"]:visible')).length ? t : e.find(".vc_panel-tabs-link:visible")).length && ((e = t.filter(function() {
                    return i(this).parent().hasClass("vc_active")
                })).length || (e = t.filter(".vc_active")), e = (t.index(e) + 1) % t.length, t.eq(e).trigger("click")), !1
            },
            closePanel: function(e) {
                e.preventDefault();
                var e = i(".vc_modal.vc_active").last();
                return e.length ? (e.removeClass("vc_active"), (e = e.find('[data-vc-ui-element="button-close"], [data-dismiss="modal"]').first()).length && e.trigger("click")) : i(".vc_ui-panel-window.vc_active").length && vc.closeActivePanel(), !1
            }
        };
    ...
    function c(e) {
        var t;
        n(e.target) && (27 === e.keyCode ? a.closePanel(e) : (e.ctrlKey || e.metaKey) && e.shiftKey && 83 === e.keyCode && (t = window.vc && window.vc.$frame && window.vc.$frame.length, a.save(e, t)))
    }
    ...
    vc.bindEditorKeys = function() {
        ...
        // nectar addition end
        var e;
        window.wpbData && !1 === window.wpbData.shortcuts_enabled || window.Mousetrap && (window.vc.mousetrapInstances = window.vc.mousetrapInstances || [], i(document).on("keydown.vcshortcuts", c), e = r(document), window.vc.mousetrapInstances.push(e), o(e, e = window.vc && window.vc.$frame && window.vc.$frame.length), e) && ((e = function() {
            var e = window.vc.$frame;
            e && e.length && e[0].contentDocument && (e = r(e[0].contentDocument), window.vc.mousetrapInstances.push(e), o(e, !0))
